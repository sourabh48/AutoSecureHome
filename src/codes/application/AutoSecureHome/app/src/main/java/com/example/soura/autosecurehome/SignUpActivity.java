            ...
            mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>()
            {
                ...
                public void onComplete(@NonNull Task<AuthResult> task)
                {
                    if (task.isSuccessful())
                    {
                        ...
                        current_device.child("TemperatureSensor").child("temperature").setValue("00");
                        current_device.child("TemperatureSensor").child("humidity").setValue("00");

                        //hall

                        current_device.child("Switches").child("hall").child("hallacswitch").setValue(false);
                        current_device.child("Switches").child("hall").child("halllightswitch").setValue(false);
                        current_device.child("Switches").child("hall").child("hallfanswitch").setValue(false);

                        //bathroom

                        current_device.child("Switches").child("Bathroom").child("BathroomHeaterswitch").setValue(false);
                        current_device.child("Switches").child("Bathroom").child("Bathroomlightswitch").setValue(false);
                        current_device.child("Switches").child("Bathroom").child("BathroomExfanswitch").setValue(false);

                        //kitchen

                        current_device.child("Switches").child("kitchen").child("kitchenfanswitch").setValue(false);
                        current_device.child("Switches").child("kitchen").child("kitchenlightswitch").setValue(false);

                        //bedroom

                        current_device.child("Switches").child("Bedroom").child("Bedroomacswitch").setValue(false);
                        current_device.child("Switches").child("Bedroom").child("Bedroomlightswitch").setValue(false);
                        current_device.child("Switches").child("Bedroom").child("Bedroomfanswitch").setValue(false);
